...
$ResultFile = Join-Path $ScriptDir "TRIAL_LEVEL_AND_HEARING_MEMBERS_CHECK_RESULT.md"
...
$testFile = Join-Path $ScriptDir "trial_level_and_hearing_members_integrity_test.sql"
...
Write-Host "Hoan thanh kiem tra cap xet xu/thanh phan phien toa. Ket qua: $ResultFile"
